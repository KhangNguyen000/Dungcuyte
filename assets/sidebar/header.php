        ...
        <div class="row">
            ...
            <div class="header__top">
                <div class="header__top-logo">
                    <h1 class="header__top-logo-text"> BOOKSTORE &nbsp;<span class="header__top-logo-text-color" style="color: #4285f4">API</span></h1>
                </div>
                <div class="header__top-action">
                    ...
                    <div class="header__top-register__login-wrap">
                        <div class="header__top-action-sign">
                            <div class="header__top-register"><a href="http://localhost/Bookstore/KhachHang/register_login.php?action=register" class="header__top-action-sign-link">ĐĂNG KÝ</a></div>
                            <div class="header__top-login"><a href="http://localhost/Bookstore/KhachHang/register_login.php?action=login" class="header__top-action-sign-link">ĐĂNG NHẬP</a></div>
                        </div>
                        ...
                        <div class="header__top-action-signed">
                            ...
                            <div class="header__top-action-signed-wrap">
                                <ul class="header__top-action-signed-wrap-list">
                                    <li class="header__top-action-signed-wrap-item"><a href="http://localhost/Bookstore/KhachHang/user.php" class="header__top-action-signed-wrap-item-link"><i class="fas fa-user-edit"></i> Quản lý tài khoản</a></li>
                                    <li class="header__top-action-signed-wrap-item"><a href="http://localhost/Bookstore/KhachHang/history.php" class="header__top-action-signed-wrap-item-link"><i class="fas fa-history"></i> Lịch sử mua hàng</a></li>
                                    <li class="header__top-action-signed-wrap-item"><a href="http://localhost/Bookstore/KhachHang/logout.php" class="header__top-action-signed-wrap-item-link"><i class="fas fa-sign-out-alt"></i> Đăng xuất</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="header__top-cart">
                        ...
                        <div class="header__top-cart-wrap--no-cart">
                            <img src="http://localhost/Bookstore/assets/image/giohang.png" alt="" class="header__top-cart-wrap-img">
                        </div>
                        <?php
                        if (isset($_SESSION['cart'])) {
                        ?>
                            <div class="header__top-cart-wrap--has-cart">
                                ...
                                <div class="header__cart-btn">
                                    <button class="header__cart-view-cart-btn"><a href="http://localhost/Bookstore/KhachHang/cart.php" class="header__cart-view-cart-btn-link">View Cart</a></button>
                                </div>
                            </div>
                        <?php
                        }
            ...
            <div class="header__bottom hide-on-mobile-tablet">
                <div class="header__bottom-navbar">
                    <div class="header__bottom-navbar-menu"> <a href="http://localhost/Bookstore/index.php" class="header__bottom-navbar-menu-link"><i class="fas fa-home"></i></a></div>
                        ...
                        <div class="header__bottom-navbar-menu-none">
                            <ul class="header__bottom-navbar-menu-none-list">
                                <li class="header__bottom-navbar-menu-none-item">
                                    ...
                                    <ul class="list__list">
                                        <li class="list__list-item"><a href="http://localhost/Bookstore/index.php?action=toan" class="list__list-item--link">TOÁN 12</a></li>
                                        <li class="list__list-item"><a href="http://localhost/Bookstore/index.php?action=vatly" class="list__list-item--link">VẬT LÝ 12</a></li>
                                        <li class="list__list-item"><a href="http://localhost/Bookstore/index.php?action=hoa" class="list__list-item--link">HÓA HỌC 12</a></li>
                                        <li class="list__list-item"><a href="http://localhost/Bookstore/index.php?action=sinh" class="list__list-item--link">SINH HỌC 12</a></li>
                                    </ul>
                                ...
                                <li class="header__bottom-navbar-menu-none-item">
                                    ...
                                    <ul class="list__list">
                                        <li class="list__list-item">
                                            <a href="http://localhost/Bookstore/index.php?action=conan" class="list__list-item--link">TRUYỆN CONAN</a>
                                        </li>
                                        <li class="list__list-item">
                                            <a href="http://localhost/Bookstore/index.php?action=thandong" class="list__list-item--link">TRUYỆN DOREAMON</a>
                                        </li>
                                        <li class="list__list-item">
                                            <a href="http://localhost/Bookstore/index.php?action=doremon" class="list__list-item--link">TRUYỆN THẦN ĐỒNG ĐẤT VIỆT</a>
                                        </li>
                ...
                <form action="http://localhost/Bookstore/index.php" method="GET" class="header__bottom-search">
