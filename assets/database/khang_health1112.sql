...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 11, 2022 lúc 04:15 AM
...
(22735531, 'dailung_1', 1, 5),
(118833737, 'maydohuyetap_2', 1, 5),
(154801977, 'ghebo_1', 1, 5),
(160548355, 'chiphauthuat_2', 17, 5),
(160548355, 'dailung_2', 1, 5),
(206126833, 'chiphauthuat_2', 1, 5),
(281361098, 'maydohuyetap_1', 2, 5),
(281361098, 'maydohuyetap_4', 1, 5),
(442155863, 'chiphauthuat_2', 1, 5),
(720516009, 'dailung_1', 1, 5),
(720516009, 'dailung_2', 1, 5),
(872002394, 'chiphauthuat_2', 1, 5),
(877208463, 'maydohuyetap_2', 1, 5),
(878601764, 'chiphauthuat_2', 3, 5),
(878601764, 'dailung_2', 1, 5),
(1011066577, 'ghebo_1', 1, 5),
(1126055998, 'ghebo_1', 1, 5),
(1126055998, 'ghebo_2', 1, 5),
(1409535012, 'dailung_1', 2, 5),
(1414254900, 'dailung_1', 1, 5),
(1720827254, 'chiphauthuat_1', 2, 5),
(1726618603, 'chiphauthuat_2', 1, 10),
(1726618603, 'dailung_1', 1, 10),
(1726618603, 'dailung_2', 2, 10),
(1855275874, 'chiphauthuat_2', 1, 5),
(1903888683, 'dailung_1', 1, 5),
(1903888683, 'dailung_2', 1, 5),
(1939509425, 'chiphauthuat_2', 1, 5),
...
INSERT INTO `dathang` (`SoDonDH`, `MSKH`, `MSNV`, `NgayDH`, `NgayGH`, `TinhTrang`) VALUES
(22735531, 'KH1935934101', 'A01', '2022-10-04', '2022-10-07', 'Đã xác nhận đơn hàng'),
(118833737, 'KH1935934101', 'A01', '2022-10-04', '2022-10-07', 'Đang vận chuyển'),
(154801977, 'KH1935934101', 'A01', '2022-12-02', '2022-12-05', 'Đang xác nhận'),
(160548355, 'KH1935934101', 'A01', '2022-09-24', '2022-09-27', 'Đã nhận hàng'),
(206126833, 'KH757328210', 'A01', '2022-12-10', '2022-12-13', 'Đang xác nhận'),
(281361098, 'KH1117995853', 'A01', '2022-10-04', '2022-10-07', 'Đang vận chuyển'),
(442155863, 'KH1935934101', 'A01', '2022-11-29', '2022-12-02', 'Đang vận chuyển'),
(720516009, 'KH1935934101', 'A01', '2022-11-29', '2022-12-02', 'Đang xác nhận'),
(872002394, 'KH1042131816', 'A01', '2022-12-02', '2022-12-05', 'Đã xác nhận đơn hàng'),
(877208463, 'KH1935934101', 'A01', '2022-12-02', '2022-12-05', 'Đang xác nhận'),
(878601764, 'KH1964103344', 'A01', '2022-11-25', '2022-11-28', 'Đang vận chuyển'),
(1011066577, 'KH1935934101', 'A01', '2022-10-04', '2022-10-07', 'Đang vận chuyển'),
(1126055998, 'KH1935934101', 'A01', '2022-11-29', '2022-12-02', 'Đang xác nhận'),
(1409535012, 'KH1935934101', 'A01', '2022-12-02', '2022-12-05', 'Đang xác nhận'),
(1414254900, 'KH1935934101', 'A01', '2022-12-10', '2022-12-13', 'Đang xác nhận'),
(1720827254, 'KH1935934101', 'A01', '2022-11-29', '2022-12-02', 'Đang xác nhận'),
(1726618603, 'KH1117995853', 'A01', '2022-09-18', '2022-09-21', 'Đã nhận hàng'),
(1855275874, 'KH1935934101', 'A01', '2022-11-29', '2022-12-02', 'Đang xác nhận'),
(1903888683, 'KH1964103344', 'A01', '2022-11-25', '2022-11-28', 'Đang xác nhận'),
(1939509425, 'KH1935934101', 'A01', '2022-11-29', '2022-12-02', 'Đang xác nhận'),
(2100933778, 'KH1117995853', 'A01', '2022-09-18', '2022-09-21', 'Đang vận chuyển');
...
('KH1042131816', 'Khu 2 DHCT', 'KH1042131816'),
('KH1117995853', 'can tho', 'KH1117995853'),
('KH1935934101', 'Can Tho', 'KH1935934101'),
('KH1964103344', 'Khu 2 DHCT', 'KH1964103344'),
('KH757328210', 'Khu 2 DHCT', 'KH757328210');
...
('maydohuyetap_2', 'Máy đo huyết áp đồng hồ', 900000, 850000, 79, '<div class=\"product-view-sa\"><div class=\"product-view-sa_one\"><div class=\"product-view-sa-supplier\"><span>Bảo hành:</span><span>36 tháng</span></div><div class=\"product-view-sa-author\"><span>Thương hiệu:</span><span>BWell</span></div></div><div class=\"product-view-sa_two\"><div class=\"product-view-sa-supplier\"><span>Xuất xứ thương hiệu:</span><span>Thụy Sỹ</span></div></div></div>$$$<table>\r\n		<colgroup><col width=\"25%\">\r\n		<col>\r\n		</colgroup><tbody>\r\n		    									    <tr>\r\n				<th class=\"table-label\">\r\n				    Mã hàng				</th>\r\n				<td class=\"data_sku\">\r\n				    8935092807832				</td>\r\n			    </tr>\r\n					    									    <tr>\r\n				<th class=\"table-label\">\r\n				    Nhà Cung Cấp\r\n	                        <td class=\"data_sku\">\r\n				    BWell </td>				</td>				</th>\r\n			\r\n					    									    \r\n			</tr>\r\n		    		</tbody>\r\n	    </table>$$$<div id=\"desc_content\" class=\"std\">\r\n		    <p dir=\"ltr\" style=\"text-align: justify;\"><strong>Máy đo huyết áp giọng nói</strong></p>\r\n\r\n<p dir=\"ltr\" style=\"text-align: justify;\"> - Máy đo huyết áp giọng nói BWell Pro-36 được sản xuất bởi hãng BWell/Thụy Sỹ với bảo hành 5 năm. Máy cho kết quả với giọng nói nên rất tiện cho mọi người đặt biệt là người cao tuổi. Máy có cảnh báo nhịp tim bất thường (PAD) & cảnh báo huyết áp cao thâp theo tiêu chuân WHO.</p>\r\n\r\n', 'maydohuyetap', 'MHA'),
...
('KH1042131816', 'Nguyen Khang Duy', 'Dai hoc Can Tho', '0907457863', 'khangduy@gmail.com', 'khangduy', 'khangduy'),
...
('KH1964103344', 'Nguyen Duy B', 'Dai hoc Can Tho', '0907457863', 'duyb@gmail.com', 'duyb', 'duyb'),
('KH757328210', 'Phan Bao Nhan', 'Dai hoc Can Tho', '0907457863', 'nhan@gmail.com', 'nhan', 'nhan'),
('KH983756603', 'dac huy', 'cta', '444444', 'huyngu@gmail.com', 'userhuy', 'huy');
...
('NV1515974541', 'Nguyen Duy Khang', 'Tổng Giám Đốc', 'ninh kieu, can tho', '495860854', 'nvkhang', 'nvkhang'),
('NV572020485', 'Nguyen Ho Quoc Huy', 'Phó giám đốc', 'ninh kiều', '1667777777', 'nvhuy', 'nvhuy');
