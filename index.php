...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/Bookstore/assets/css/slideshow.css">
                        ...
                        <div class="home-product">
                            <div class="row">
                                ...
                                if (isset($_GET['action'])) {
                                    ...
                                    if ($action == 'toan') {
                                        $sql = "select * from hanghoa as a, hinhhanghoa as b where tags='$action' AND a.MSHH = b.MSHH";
                                    }
                                    if ($action == 'vatly') {
                                        $sql = "select * from hanghoa as a, hinhhanghoa as b where tags='$action' AND a.MSHH = b.MSHH";
                                    }
