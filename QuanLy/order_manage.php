                            ...
                            ?>
                                <tr class="table_oder__content">
                                    ...
                                    <td class="table__td-action-order">
                                        <button class="action__btn edit"><a href="http://localhost/Dungcuyte/QuanLy/order_manage.php?action=show&id=<?= $row['SoDonDH'] ?>&ms=<?= $row['MSKH'] ?>" class="action__link">Show</a></button>
                                        <button class="action__btn del"><a href="http://localhost/Dungcuyte/QuanLy/order_manage.php?action=delete&id=<?= $row['SoDonDH'] ?>" class="action__link">Delete</a></button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </table>
