                    ...
                    <div class="col l-2 m-0 c-0">
                        ...
                        <nav class="category">
                            ...
                            <ul class="category-list">
                                ...
                                <li class="category-item">
                                    <a href="http://localhost/Bookstore/QuanLy/order_manage.php" class="category-item-active category-item-link">Order Manage</a>
                                </li>
                                <li class="category-item">
                            ...
                            ?>
                                <tr class="table_oder__content">
                                    ...
                                    <td class="table__td-action-order">
                                        <button class="action__btn edit"><a href="http://localhost/Bookstore/QuanLy/order_manage.php?action=show&id=<?= $row['SoDonDH'] ?>&ms=<?= $row['MSKH'] ?>" class="action__link">Show</a></button>
                                        <button class="action__btn del"><a href="http://localhost/Bookstore/QuanLy/order_manage.php?action=delete&id=<?= $row['SoDonDH'] ?>" class="action__link">Delete</a></button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </table>
